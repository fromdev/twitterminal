...
<body>
	...
	<form class="form-horizontal" action="followservlet">
		<br />
		<br />
		<br />
		<h2>Follow a User</h2>
		...
		<div class="form-group required">
			<label for="followuser" class="control-label col-xs-2">Follow User</label>
			<div class="col-xs-4">
				<input type="text" class="form-control" name="followuser" required="required" 		placeholder="Screen Name">
			</div>
		</div>
		<br />
		<div class="form-group required">
